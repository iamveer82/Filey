...
export const BILL_ICONS = [
  ...
  { id: 'apple',      label: 'Apple',       bg: '#F2F2F2', tint: '#0B1324',
  ...
  { id: 'github',     label: 'GitHub',      bg: '#ECECEC', tint: '#0B1324',
  ...
  { id: 'notion',     label: 'Notion',      bg: '#F2F2F2', tint: '#0B1324',
    xml: svg('<rect x="3" y="3" width="18" height="18" rx="2" fill="#fff" stroke="#0B1324"/><path d="M8 8l8 10V8" stroke="#0B1324" stroke-width="1.5" fill="none"/>') },
  ...
  { id: 'wifi',       label: 'Internet',    bg: '#E8EFFF', tint: '#0F53DC',
    xml: svg('<path fill="none" stroke="#0F53DC" stroke-width="2" stroke-linecap="round" d="M2 9a15 15 0 0 1 20 0M5 13a10 10 0 0 1 14 0M8 17a5 5 0 0 1 8 0"/><circle cx="12" cy="20" r="1.5" fill="#0F53DC"/>') },
  ...
  { id: 'creditcard', label: 'Credit Card', bg: '#E8EFFF', tint: '#0F53DC',
    xml: svg('<rect x="2" y="5" width="20" height="14" rx="2" fill="#0F53DC"/><rect x="2" y="9" width="20" height="2" fill="#0A3DA6"/><rect x="5" y="14" width="5" height="2" rx="1" fill="#fff"/>') },
  ...
  { id: 'misc',       label: 'Other',       bg: '#E8EFFF', tint: '#0F53DC',
    xml: svg('<circle cx="12" cy="12" r="9" fill="none" stroke="#0F53DC" stroke-width="2"/><path stroke="#0F53DC" stroke-width="2" stroke-linecap="round" fill="none" d="M9 9a3 3 0 1 1 5 2c-1 1-2 1-2 3"/><circle cx="12" cy="17" r="1" fill="#0F53DC"/>') },
];
