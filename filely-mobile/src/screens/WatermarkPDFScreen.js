        ...
        {pdf && (
          <Animated.View entering={FadeInUp.duration(300)}>
            <View style={styles.pdfChip}>
              <Ionicons name="document-text" size={20} color="#0F53DC" />
            ...
            <View style={styles.opacityTrack}>
              {[0.05, 0.1, 0.15, 0.25, 0.4].map((v) => (
                <Pressable key={v} onPress={() => setOpacity(v)} style={styles.opacityChip}>
                  <View style={[styles.opacityChipInner, opacity === v && { backgroundColor: '#0F53DC' }]}>
...
const styles = StyleSheet.create({
  ...
  pickCard: {
    backgroundColor: '#F8FAFC', borderRadius: 18, borderWidth: 1, borderColor: 'rgba(11,19,36,0.08)',
    borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center', paddingVertical: 44, gap: 8,
  },
  pickTitle: { fontSize: 16, fontWeight: '700', color: '#0B1324' },
  pickDesc: { fontSize: 13, color: 'rgba(11,19,36,0.45)', textAlign: 'center' },
  ...
  pdfChipName: { flex: 1, fontSize: 14, fontWeight: '600', color: '#0B1324' },
  ...
  modeBtnActive: { backgroundColor: '#0F53DC' },
  modeText: { fontSize: 13, fontWeight: '700', color: 'rgba(11,19,36,0.55)' },
  modeTextActive: { color: '#FFFFFF' },

  section: { marginBottom: 20 },
  sectionLabel: {
    fontSize: 11, fontWeight: '700', color: 'rgba(11,19,36,0.45)', letterSpacing: 0.8, marginBottom: 10,
  },
  input: {
    height: 52, borderRadius: 14, backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: 'rgba(11,19,36,0.08)',
    paddingHorizontal: 14, fontSize: 15, color: '#0B1324',
  },

  opacityRow: { alignItems: 'flex-end', marginBottom: 8 },
  opacityValue: { fontSize: 13, fontWeight: '700', color: '#0F53DC' },
  ...
  opacityChipInner: {
    ...
    backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: 'rgba(11,19,36,0.08)',
  },
  opacityChipText: { fontSize: 12, fontWeight: '700', color: '#0B1324' },

  previewBox: { marginTop: 4 },
  previewLabel: { fontSize: 11, fontWeight: '700', color: 'rgba(11,19,36,0.45)', letterSpacing: 0.8, marginBottom: 8 },
  previewCanvas: {
    height: 120, borderRadius: 14, backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: 'rgba(11,19,36,0.08)',
    alignItems: 'center', justifyContent: 'center', overflow: 'hidden',
  },
  previewWatermark: { fontSize: 22, fontWeight: '800', color: '#0B1324', transform: [{ rotate: '-15deg' }] },
