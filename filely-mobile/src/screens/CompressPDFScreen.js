...
const styles = StyleSheet.create({
  ...
  pdfChipMeta: { fontSize: 12, color: 'rgba(11,19,36,0.45)', marginTop: 2 },
  ...
  qualityLabel: { fontSize: 15, fontWeight: '700', color: '#0B1324' },
  qualityDesc: { fontSize: 12, color: 'rgba(11,19,36,0.5)', marginTop: 2 },
  ...
  resultTitle: { fontSize: 15, fontWeight: '700', color: '#0B1324' },
  resultMeta: { fontSize: 13, color: 'rgba(11,19,36,0.55)', textAlign: 'center' },
